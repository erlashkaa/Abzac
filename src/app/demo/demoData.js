...
export const DEMO_BOOKS = [
    {
        ...
        content: 'Город светился холодным неоном, будто кто-то забыл выключить лабораторию.\n\n' +
    ...
    },
    {
        ...
        content: 'Иногда перемены начинаются не с решения, а с усталости.\n\n' +
    ...
    },
    {
        ...
        content: 'Когда легенды просыпаются, люди вспоминают страх.\n\n' +
    ...
    },
    {
        ...
        content: 'Мы не “ленивые”. Мы экономим усилие.\n\n' +
    ...
    },
    {
        ...
        content: 'Дом стоял, как пауза в разговоре.\n\n' +
...
const userAvatar = (id) => userById(id)?.avatar || '';
const userName = (id) => userById(id)?.username || 'Пользователь';
export const DEMO_REVIEWS_BY_BOOK = {
    91001: [
        {
            id: 99001,
            book_id: 91001,
...
export const getDemoBook = (id) => DEMO_BOOKS.find((b) => b.id === id) || null;
export const getDemoReviews = (bookId) => DEMO_REVIEWS_BY_BOOK[bookId] || [];
...
export const mergeWithDemoBooks = (real, { targetSize = 10 } = {}) => {
...
export const isDemoId = (id) => id >= 9000;
